/**
 * Achievement panel compatible with ServerPerk's ESC menu.  This class is 
 * copy-pasted from the AchievementPanel class with some minor touchups to 
 * accomodate the differences in ServerPerk's menu.  The code should be 
 * consolidated into one class, rather than the copy-paste approach
 * @author etsai (Scary Ghost)
 */
class SRAchievementPanel extends MidGamePanel;
